...
export const RegisterProducerPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAF6EE] px-4 py-10">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-md border border-[#EAE1D2] p-6 sm:p-8">
        <h1 className="text-xl font-bold text-[#0C261B] mb-1 text-center">{t('auth:registerProducer.title')}</h1>
        <p className="text-sm text-gray-500 text-center mb-6">{t('auth:registerProducer.subtitle')}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <Input
            ...
            placeholder={t('auth:registerProducer.namePlaceholder')}
          />
          <Input
          ...
          />
          <Input
            label={t('auth:registerProducer.farmNameLabel')}
            required
            value={form.farmName}
            onChange={update('farmName')}
            placeholder={t('auth:registerProducer.farmNamePlaceholder')}
          />
          <Input
            label={t('auth:registerProducer.locationLabel')}
            required
            value={form.location}
            onChange={update('location')}
            placeholder={t('auth:registerProducer.locationPlaceholder')}
          />
